...
async def cmd_start(message: types.Message):
    ...
    Ця функція відповідає користувачу на команду /start, відправляючи привітальне повідомлення
    та пропонуючи основні варіанти взаємодії з ботом.

    Аргументи:
        message (types.Message): Повідомлення, що містить дані про команду /start.
    """
