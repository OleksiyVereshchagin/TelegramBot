...
async def execute_query(query: str, *args):
    ...
    Ця функція встановлює з'єднання з базою даних і виконує переданий SQL-запит із параметрами.
    Якщо з'єднання не вдалося встановити або виникла помилка при виконанні запиту,
    вона виводить повідомлення про помилку. Після виконання запиту з'єднання з базою даних закривається.

    Аргументи:
        query (str): SQL-запит, який потрібно виконати.
        *args: Додаткові параметри, які передаються в запит (наприклад, значення для параметризованих запитів).

    Повертає:
        Результат виконання запиту або None, якщо з'єднання не вдалося встановити або виникла помилка.

    Винятки:
        PostgresError: Якщо виникає помилка під час виконання запиту, вона буде виведена в консоль.
    """
